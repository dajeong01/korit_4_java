...
/*
    주석(comment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링하는데,
        거기서 오류가 하나로 발생하면 전체 프로그램이 실행 x
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 제다정입니다.");
//      System.out.println(안녕하세요, 제 이름은 제다정입니다.); -> 오류 발생
        ...
        // 명령문에 데이터(변수에 대입되지 않은 데이터 : 리터럴(literal))를 바로 집어넣는 것
        ...
        String introduction = "안녕하세요, 저는 java를 배우게 된 제다정입니다.";
        ...
        boolean checkFlag1 = false;     // 자료형 변수명 = 데이터; : 변수의 초기 및 초기화
        checkFlag1 = true;              // 변수에 데이터 재대입
        ...
        /*
            ...
            문자(하나짜리를) 세 번 더했을 경우에 더 이상 문자가 아니라 문자열로 인식되기 때문에
            원하는 방식으로 출력되지 않습니다(ex) 60 line)
        ...
        String width3 = "300";
        String width4 = "400";
        System.out.println(width3 + width4);    // 300400 문자열끼리는 연산이 아니라 나열
...
//        int pi2 = 3.14;
        ...
        /*
            Java에서의 변수 표기 방식 :
                1. 카멜 표기법(Camel case)를 사용
                    : 첫 문자는 소문자로 시작
                    복수의 단어로 이루어졌을 경우 두 번째 단어의 첫번째 문자만 대문자
                    ex) result
                    ex) myTestResult
        ...
        String name = "제다정";
        String major = "생물공학과";
        String currentJob = "백수^^;";
        String previousJob = "대학생";
        ...
        + "이고, 그래서 예전 직업은 " + previousJob + "이었습니다. 현재는 " + currentJob + "입니다");
