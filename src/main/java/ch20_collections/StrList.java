...
public class StrList {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(strArray1)); // 배열을 출력하기 위해 static method를 경유해야함.
        ...
        String searchElem2 = "py";      // 하드 코딩을 피하기 위해 변수 대입
        ...
        System.out.println("@ 포함 여부 : " + contains3);
        ...
        // python 언어 java언어 javascript 언어 c# 언어로 출력될 수 있또록 작성하시오.
        // 참고 : strList1.length는 안 먹습니다. -> List는 .size를 씁니다(근데 필드가 아니라 메서드입니다)
