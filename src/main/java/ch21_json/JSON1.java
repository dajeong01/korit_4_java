...
public class JSON1 {
    public static void main(String[] args) {
        ...
        System.out.println(jsonObject1);
        /*
            콘솔에 출력된 값을 확인해보면 한 줄로 길게 늘어져있습니다.
            addProperty()를 통해 키-값 쌍을 늘릴수록 계속 길어져서 가독성을 해치게될 것으로 보입니다.
            .md 파일에서 작성한것처럼 key:value마다 개행이 이루어지면 나을 것 같습니다.
            이때 사용하는 것이 Gson관련 클래스입니다.
         */
