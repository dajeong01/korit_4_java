...
public class Main {
    public static void main(String[] args) {
        ...
        // 업캐스팅 방법 # 1
        // 형변환을 하기 위해서는 '(바꿀 테이터타입) 변수명'으로 작성하시면 됩니다.
        System.out.println("변형 : " + (int)cast1);       // A 는 65 기억해두는게 좋음
        char cast2 = 'a';
        System.out.println("원형 : " + cast2);
        System.out.println("변형 : " + (int)cast2);       // a 는 97 정도 기억해주기
