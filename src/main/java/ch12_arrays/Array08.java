...
/*
    ...
    그리고 toString()이라는 메서드 역시 추후 수업 예정이지만 매우 중요한 내용
 */

        // 1. 1차 배열의 출력
        System.out.println(Arrays.toString(students));  // 결과값 : [김영, 김일, 김이, 김삼]
        System.out.println(Arrays.toString(scores));    // [[D@4c873330, [D@119d7047, [D@776ec8df, [D@4eec7777]

        // 2. 2차 이상의 배열 출력
        // 형식 : Arrays.deepToString(배열명);
        System.out.println(Arrays.deepToString(scores)); // [[100.0, 96.4], [64.2, 79.3], [48.1, 99.8], [80.5, 4.5]]
    }
}
